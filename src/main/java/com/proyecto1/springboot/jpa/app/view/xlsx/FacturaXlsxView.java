package com.proyecto1.springboot.jpa.app.view.xlsx;
...
public class FacturaXlsxView extends AbstractXlsxView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		//Primera forma para crear filas y columnas en archivo excel: crear objeto Row y objeto Cell
		...
		//segunda forma para crear filas y columnas en archivo excel: encadenando métodos createRow(), createCell() y setCellValue()
		...
		sheet.createRow(7).createCell(0).setCellValue(mensajes.getMessage("text.cliente.factura.fecha") + ": " + factura.getCreadoEn());
